...
const mainCss = [
  ...
  css`
    &:disabled {
      ${tw`cursor-not-allowed shadow-none`}
    }
  `,
  css`
    &:active,
    &:hover {
      ${tw`bg-$violet text-white`}
    }
  `,
  css`
    &:disabled,
